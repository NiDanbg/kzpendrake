const authorData = {
    ...
    "meta": {
        "bg": {
            "intro": "K.Z. Pendrake обръща фантастичното с главата надолу — с дракони, които имат мнение, космически кораби с проблеми с характера, и герои, които наистина предпочитат да са някъде другаде. Хумористично фентъзи и научна фантастика, която те кара да мислиш между смеховете. <a href=\"/bg/about/\">Научете повече...</a>",
            "name": "K.Z. Pendrake",
            "siteTitle": "K.Z. Pendrake | Автор"
        },
        "en": {
            "intro": "K.Z. Pendrake turns the fantastical on its head — with dragons who have opinions, spaceships with attitude problems, and heroes who'd really rather be somewhere else. Comic fantasy and sci-fi that make you think between laughs. <a href=\"/about/\">Learn more...</a>",
            "name": "K.Z. Pendrake",
            "siteTitle": "K.Z. Pendrake | Author"
        },
        "photo": "images/common/author-kzpendrake.jpg"
    },
    "novels": [
        {
            "i18n": {
    ...
    "series": [
        {
            ...
            "i18n": {
                "bg": {
                    "series_synopsis": "Хумористично уютно фентъзи приключение",
                    "title": "Магическите злополуки на Куибълтаун"
                },
                "en": {
                    "series_synopsis": "A Humorous Cozy Fantasy Adventure",
                    "title": "The Quibbletown Magical Misadventures"
                }
            },
            "id": "the-quibbletown-magical-misadventures",
            "seriesImage": "images/common/k.webp"
        }
    ],
    "short_stories": []
};
